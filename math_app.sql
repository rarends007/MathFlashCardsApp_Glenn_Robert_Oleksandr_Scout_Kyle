...
-- users
-- =====================================================================
INSERT INTO user (username, password, first_name, middle_name, last_name, role, bananna_stickers, points) VALUES
('teacher1',   'hashedpass123',  'Scout',     'E',      'Earnst',  'TCH',  0,   0),
('teacher2',   'pass456secure',  'James',     'Theodore',      'Wilson',    'TCH',  0,   0),
('teacher3',   'hashedpass123',  'Oleksandr',   NULL,      'Khokhulia',  'TCH',  0,   0),
('teacher4',   'hashedpass123',  'Kyle',       'E',      'Stuart',  'TCH',  0,   150),
('studenta',   'abc123',         'Snow',      NULL,      'Arends',   'STU', 20,  2450),
('studentb',   'pass2025',       'Leon',      'Teran',      'Arends',      'STU',  0,  1870),
('studentc',   'mathrox',        'Sophia',    NULL,      'Jacobs',  'STU', 50,  3980),
('ADMIN001',      'IamGOD',       'Glenn',    NULL,      'Ray',       'ADM',  0,   920),
('parent01',    'family2025',     'Robert',  'Charles', 'Arends',    'PAR',  0,     0),
('parent02',    'secure4kids',    'Xue',      NULL,      'Arends',    'PAR',  0,     0);
